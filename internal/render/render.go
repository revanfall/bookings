...
var functions = template.FuncMap{"humanDate": HumanDate, "formatDate": FormatDate, "iterate": Iterate, "add": Add}
...
// Iterate returns slice of ints starting at 1 going to count
